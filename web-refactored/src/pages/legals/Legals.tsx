...
const complianceTimeline = [
  {
    ...
    detail:
      "Superamos la revisión de la Agencia Española de Protección de Datos sin observaciones críticas.",
    status: "Completado",
  },
  {
    year: "2023",
    label: "ISO 14064-1",
    detail:
      "Certificamos nuestra metodología de cálculo de emisiones para proyectos fotovoltaicos e híbridos.",
    status: "Vigente",
  },
  {
    year: "2024",
