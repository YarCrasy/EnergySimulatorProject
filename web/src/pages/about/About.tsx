...
import domestic from "../../assets/images/jpg/domestic.jpg";
import comunity from "../../assets/images/jpg/comunity.jpg";
import industrial from "../../assets/images/jpg/industrial.jpg";
import greenWorld from "../../assets/images/jpg/greenWorld.jpg";
import innovation from "../../assets/images/jpg/innovation.jpg";
  ...
  return (
    <main className="about-page">
      <section className="about-hero">
        ...
        <div className="about-hero_layout">
          <div>
            <h1>Equipos de energía renovable conectados a un mismo flujo digital</h1>
            <p>
              Aceleramos el diseño, evaluación y seguimiento de proyectos solares y eólicos con
              herramientas creadas para ingeniería, finanzas y operaciones.
            </p>
      ...
      <section className="about-cta">
        <div>
          ...
          <p>
            Regístrate para acceder al simulador, comparte escenarios con tu equipo y mantén control
            total del CAPEX y OPEX.
          </p>
        </div>
        <div className="about-cta_actions">
          <Link to="/register" className="btn-primary">
            Crear cuenta
          </Link>
          <Link to="/legals" className="btn-ghost">
            Ver compromisos
          </Link>
        </div>
      </section>
